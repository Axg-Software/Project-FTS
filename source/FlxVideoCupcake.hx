...
class FlxVideoCupcake extends FlxBasic
{
	var video:Video;
	...
	{
		netStream.play(AssetPaths.cupcakeJumpscare__mp4);
	}

	public function playFreddy()
	{
		netStream.play(AssetPaths.frdJumpscare__mp4);
	}

	public function playBonnie()
	{
		netStream.play(AssetPaths.bonnieJumpscare__mp4);
	}

	public function playFoxy()
	{
		netStream.play(AssetPaths.foxyJumpscare__mp4);
	}
